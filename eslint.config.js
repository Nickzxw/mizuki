...
export default tseslint.config(
	// Ignores
	{
		ignores: [
			...
			"src/components/features/toc/card-toc/CardTOC.astro",
			"src/components/layout/navigation/DropdownMenu.astro",
			...
			"src/components/common/custom-scrollbar/CustomScrollbar.astro",
			"src/components/common/typewriter-text/TypewriterText.astro",
			"src/components/features/announcement/Announcement.astro",
			"src/components/features/music-player/WidgetLayout.astro",
		],
	},
